...
Implementing continuous integration (CI) with GitHub Actions and tox streamlined the project testing across multiple environments. On every pull request the
GitHub workflow ran our test units using pytest. In total we got well over 90\% coverage.
