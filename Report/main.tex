...
\firstauthor{Student name}

\secondauthor{Student name}

% Report Title & Subtitle
\title{Report: Simulation of an oil spill}
%TODO: Add subtitle here:
\subtitle{Your own subtitle \\ with a line break}
...
This is the introduction. The following text provides a few helpful commands in latex. You can refer to other chapters titled \nameref{ch:images} (referred to as \autoref{ch:images}). You can use code statements \texttt{which take this font}. Also, you can put \emph{emphasis on certain words}. To make text bold use \textbf{this command}. A new line can be started like this. You can also cite others via \cite{khodak2021initialization, vaswani2017attention} when adding the corresponding entry into the \emph{Bibliography} folder.\\
