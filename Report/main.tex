...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1.1\linewidth]{Figures/deepwater-horizonbp-oil-spill.jpg}
  \captionof{figure}{Deepwater Horizon BP oil spill\\ Public domain media}
  \label{fig:Deepwater Horizon BP oil spill}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.8\linewidth]{Figures/BayCity.png}
  \captionof{figure}{Bay city}
  \label{fig:Bay city from task}
\end{minipage}
\end{figure}
